...
from lattice_weaver.core.csp_engine.constraints import NoAttackQueensConstraint
    ...
    def generate(self, **params):
        ...
        for i in range(n):
            for j in range(i + 1, n):
                ...
                cg.add_constraint(var_i, var_j, NoAttackQueensConstraint(col_diff=abs(i - j)))
                constraint_count += 1
